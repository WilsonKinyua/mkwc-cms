...
class HomeController
{
    public function index()
    {
        ...
        $settings2 = [
            'chart_title'           => 'Email Subscribers',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\NewsletterEmail',
            ...
            'column_class'          => 'col-md-3',
            'entries_number'        => '5',
            'translation_key'       => 'newsletterEmail',
        ];
        ...
        $settings3 = [
            'chart_title'           => 'Contact Us Messages',
            'chart_type'            => 'number_block',
            'report_type'           => 'group_by_date',
        ...
        $settings6 = [
            'chart_title'           => 'Latest Newsletter Email Subscribers',
            'chart_type'            => 'latest_entries',
            'report_type'           => 'group_by_date',
            'model'                 => 'App\Models\NewsletterEmail',
            'group_by_field'        => 'created_at',
