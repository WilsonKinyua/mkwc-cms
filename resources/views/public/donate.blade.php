...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 bg-color text-white p-4">
                <h4>Become a Member</h4>
                <p>All the animals in our care benefit from your adoption, and the fee helps pay for their care, veterinary
                    expenses, nutritional needs, and wilderness adaptation training. Becoming a member also means we will
                    honor you on our colorful wall of tiles at the Animal Orphanage. Simply become a friend of Mount Kenya
                ...
                <ul>
                    ...
                    <li class="mb-4"><b>Golden Friend - $500</b><br>
                        You will be issued a certificate, the Conservancy's prestigious embroidered badge and a gold title
                        bearing your name.
                    </li>
                    <li class="mb-4"><b>Platinum Friend</b><br>
                        You will be issued a certificate, the Conservancy's prestigious embroidered badge and a platinum
                        tile
                        bearing your name.
                    </li>
                    <li class="mb-4"><b>Wildlife Guardian – $10,000</b><br>
                        You will be issued a certificate, the Conservancy's prestigious embroidered badge and an ivory title
                        bearing your family or corporate name.
                    </li>

                </ul>
            </div>
            <div class="col-md-6 bg-sec-color text-white p-4">
            ...
            <div class="col-md-6 p-4">
                <h4>Volunteer</h4>
                <p>As Mount Kenya Wildlife Conservancy strives to prevent the extinction of wildlife species, its long-term
                    goals must complement environmental conservation by instilling knowledge to young "budding
                    conservationists".
                </p>
                <p>The Conservancy allows interns to work alongside our experienced keepers at the Animal Orphanage or out
                    in the field. Many of our volunteer interns move on to jobs in related fields after graduation, and most
