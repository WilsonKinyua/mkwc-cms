<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('in_the_press_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/in-the-news*") ? "c-show" : "" }} {{ request()->is("admin/in-the-media*") ? "c-show" : "" }} {{ request()->is("admin/quotes*") ? "c-show" : "" }} {{ request()->is("admin/media-resources*") ? "c-show" : "" }}">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    @can('in_the_new_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.in-the-news.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/in-the-news") || request()->is("admin/in-the-news/*") ? "c-active" : "" }}">
                    ...
                    @can('in_the_medium_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.in-the-media.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/in-the-media") || request()->is("admin/in-the-media/*") ? "c-active" : "" }}">
                    ...
                    @can('media_resource_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.media-resources.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/media-resources") || request()->is("admin/media-resources/*") ? "c-active" : "" }}">
        ...
        @can('newsletter_email_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.newsletter-emails.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/newsletter-emails") || request()->is("admin/newsletter-emails/*") ? "c-active" : "" }}">
        ...
        @endcan
        @can('partner_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/partner-categories*") ? "c-show" : "" }} {{ request()->is("admin/mkwc-partners*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                ...
                <ul class="c-sidebar-nav-dropdown-items">
                    ...
                    @can('mkwc_partner_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.mkwc-partners.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/mkwc-partners") || request()->is("admin/mkwc-partners/*") ? "c-active" : "" }}">
        ...
        @can('gallery_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/gallery-categories*") ? "c-show" : "" }} {{ request()->is("admin/galleries*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
