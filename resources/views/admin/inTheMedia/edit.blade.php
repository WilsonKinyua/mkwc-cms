...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.inTheMedium.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.in-the-media.update", [$inTheMedium->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.inTheMedium.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $inTheMedium->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('media_house') ? 'is-invalid' : '' }}" type="text" name="media_house" id="media_house" value="{{ old('media_house', $inTheMedium->media_house) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" type="text" name="category" id="category" value="{{ old('category', $inTheMedium->category) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('media_url_link') ? 'is-invalid' : '' }}" name="media_url_link" id="media_url_link" required>{{ old('media_url_link', $inTheMedium->media_url_link) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $inTheMedium->date) }}">
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
