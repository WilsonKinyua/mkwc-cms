            ...
            <form method="POST" action="{{ route('admin.newsletters.update', [$newsletter->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title"
                        id="title" value="{{ old('title', $newsletter->title) }}" required>
                    @if ($errors->has('title'))
                ...
                <div class="form-group">
                    <label class="required" for="title">Order</label>
                    <input class="form-control" type="number" name="in_order" id="order"
                        value="{{ old('in_order', $newsletter->in_order) }}" required>
                </div>
                <div class="form-group">
                    <label class="required"
                        for="newsletter_image">{{ trans('cruds.newsletter.fields.newsletter_image') }}</label>
                    <div class="needsclick dropzone {{ $errors->has('newsletter_image') ? 'is-invalid' : '' }}"
                        id="newsletter_image-dropzone">
                    </div>
                ...
                <div class="form-group">
                    <label class="required"
                        for="document_file">{{ trans('cruds.newsletter.fields.document_file') }}</label>
