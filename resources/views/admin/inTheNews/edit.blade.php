...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.inTheNew.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.in-the-news.update", [$inTheNew->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="title">{{ trans('cruds.inTheNew.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $inTheNew->title) }}" required>
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('caption') ? 'is-invalid' : '' }}" name="caption" id="caption">{!! old('caption', $inTheNew->caption) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('date_location') ? 'is-invalid' : '' }}" type="text" name="date_location" id="date_location" value="{{ old('date_location', $inTheNew->date_location) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $inTheNew->description) !!}</textarea>
